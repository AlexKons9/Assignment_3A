namespace EFCodeFirstAdminStudent.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CandidateId_CandidateId = c.Int(),
                        CertificateType_Id = c.Int(nullable: false),
                        Exam_ExamsId = c.Int(),
                    })
                .PrimaryKey(t => t.CertificateId)
                .ForeignKey("dbo.Candidates", t => t.CandidateId_CandidateId)
                ...
                c => new
                    {
                        ...
                        MarkPerTopic_Id = c.Int(),
                    })
                .PrimaryKey(t => t.ExamsId)
                .ForeignKey("dbo.Candidates", t => t.CandidateId_CandidateId)
                .ForeignKey("dbo.CertificateTypes", t => t.CertificateType_Id)
                .ForeignKey("dbo.MarkPerTopics", t => t.MarkPerTopic_Id)
                .Index(t => t.CandidateId_CandidateId)
                .Index(t => t.CertificateType_Id)
                .Index(t => t.MarkPerTopic_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Exams", "MarkPerTopic_Id", "dbo.MarkPerTopics");
            ...
            DropIndex("dbo.Exams", new[] { "MarkPerTopic_Id" });
